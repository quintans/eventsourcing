...
func (f AggregateFactoryV2) New(kind string) (eventsourcing.Typer, error) {
	switch kind {
	case "Account":
		return NewAccountV2(), nil
	default:
		evt, err := f.EventFactoryV2.New(kind)
		if err != nil {
			return nil, err
		}
		return evt, nil
...
func (EventFactoryV2) New(kind string) (eventsourcing.Typer, error) {
